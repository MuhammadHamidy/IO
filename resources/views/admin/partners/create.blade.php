        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="regional" name="regional" required
                        ...
                        <option value="Asia" {{ old('regional') === 'Asia' ? 'selected' : '' }}>Asia</option>
                        <option value="Europe" {{ old('regional') === 'Europe' ? 'selected' : '' }}>Europe</option>
                        <option value="North America" {{ old('regional') === 'North America' ? 'selected' : '' }}>North America</option>
                        <option value="South America" {{ old('regional') === 'South America' ? 'selected' : '' }}>South America</option>
                        <option value="Africa" {{ old('regional') === 'Africa' ? 'selected' : '' }}>Africa</option>
                        <option value="Oceania" {{ old('regional') === 'Oceania' ? 'selected' : '' }}>Oceania</option>
                    </select>
                    @error('regional')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div>
                ...
                <select id="category" name="category" required
                    ...
                    <option value="University" {{ old('category') === 'University' ? 'selected' : '' }}>🎓 University</option>
                    <option value="Organization" {{ old('category') === 'Organization' ? 'selected' : '' }}>🏢 Organization</option>
                    <option value="Embassy" {{ old('category') === 'Embassy' ? 'selected' : '' }}>🏛️ Embassy</option>
                    <option value="Government Agency" {{ old('category') === 'Government Agency' ? 'selected' : '' }}>🏛️ Government Agency</option>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          ...
                          placeholder="Enter partner description (optional)...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
