<x-layout>
    ...
    <div class="min-w-max min-h-max sm:min-w-screen sm:min-h-screen p-[100px] flex flex-col gap-16 items-center justify-center bg-cover" style="background-image: url('{{asset('img/auth-background.png')}}')">
        <img src="{{asset('img/logo-white.png')}}" class=" w-[100px] h-[60px] sm:w-[182px] sm:h-[130px]"/>
        ...
        <div class="flex flex-col px-20 py-10 bg-[#1F4894] bg-opacity-85 gap-4 sm:gap-12">
            ...
            <form class="w-full h-fit flex flex-col gap-2" method="POST" action="{{ route('login') }}">
                @csrf
                ...
                <div class="w-full flex flex-col justify-center items-center">
                    ...
                    <div class="my-6 text-[14px] text-white">Don't have account yet? <a href="{{ route('regist-inbound') }}" class="text-white underline">Register Here</a></div>
                </div>
                <script>
