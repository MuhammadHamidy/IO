<x-layout>
    ...
    <div class="relative bg-gradient-to-br from-[#1F4894] via-[#275DCB] to-[#2D5F3F] py-20 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <!-- Back Button -->
            <div class="mb-8">
                <a href="{{ route('global-network') }}" class="inline-flex items-center gap-2 text-white hover:text-[#C4D25A] transition-colors group">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:border-[#C4D25A] transition-all duration-300 hover:shadow-2xl">
                            <button @click="open = !open" class="w-full px-6 md:px-8 py-6 flex items-center justify-between bg-gradient-to-r from-white to-gray-50 hover:from-gray-50 hover:to-white transition-all duration-300">
                                <div class="flex items-center space-x-4 md:space-x-6">
                                    ...
                                    <div class="text-left">
                                        <h3 class="text-xl md:text-2xl font-bold text-gray-900 group-hover:text-[#1F4894] transition-colors">{{ $continent }}</h3>
                                        <p class="text-sm text-gray-500 mt-1">
                                            <span class="font-semibold text-[#2D5F3F]">{{ $partnerCount }}</span> 
                                            {{ $partnerCount === 1 ? 'Partnership Institution' : 'Partnership Institutions' }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div x-show="open" 
                                ...
                                <div class="p-6 md:p-8 bg-gradient-to-br from-gray-50 to-white border-t border-gray-100">
                                    @if(isset($pagePartners[$continent]) && $pagePartners[$continent]->isNotEmpty())
                                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
                                            @foreach($pagePartners[$continent] as $partner)
                                                @php
                                                ...
                                                <div class="group/card">
                                                    <a href="{{ route('partners.detail', ['id' => $partner->id]) }}" class="block h-full">
                                                                ...
                                                                @if($partner->category)
                                                                    <div class="absolute top-2 right-2">
                                                                        <span class="inline-flex items-center gap-1 px-2 py-1 bg-white shadow-md text-xs font-semibold rounded-full border border-gray-200">
                                                                            ...
                                                                            @elseif($partner->category === 'Government Agency') 
                                                                                <span class="text-lg">🏛️</span>
                                                                            @else 
                                                                                <span class="text-lg">💼</span>
                                                                            @endif
                                                            ...
                                                            <div class="p-4 bg-gradient-to-br from-[#1F4894] to-[#275DCB] flex-grow flex flex-col justify-between">
                                                                ...
                                                                <div class="space-y-2 mt-2">
                                                                    <div class="flex items-center text-xs text-blue-100">
                                                                        ...
                                                                        <span class="line-clamp-1 font-medium">{{ $countryName }}</span>
                                                                    </div>
    ...
    <div class="bg-gray-50 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <a href="{{ route('global-network') }}" class="inline-flex items-center gap-3 bg-gradient-to-r from-[#1F4894] to-[#275DCB] text-white font-bold px-10 py-5 rounded-xl hover:from-[#163872] hover:to-[#1e4da3] transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
