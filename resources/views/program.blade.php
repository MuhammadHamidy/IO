                            ...
                            <div class="relative">
                                @if($program->image)
                                    <div class="h-64 md:h-96 overflow-hidden">
                                        <img src="{{ asset('storage/' . $program->image) }}" alt="{{ $program->title }}" class="w-full h-full object-cover opacity-20">
                                    </div>
                                    ...
                                    <div class="flex flex-wrap items-center gap-3 mt-6">
                                        @if($program->program_type)
                                            <div class="bg-purple-500/90 backdrop-blur-sm px-4 py-2 rounded-lg">
                                                <span class="text-white font-semibold text-sm">{{ ucfirst($program->program_type) }}</span>
                        </div>
                                        @endif

                                        @if($program->category)
                                            <div class="bg-indigo-500/90 backdrop-blur-sm px-4 py-2 rounded-lg">
                                                <span class="text-white font-semibold text-sm">{{ $program->category }}</span>
                    </div>
                                        @endif
                                        ...
                                        @if($program->duration)
                                            <div class="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg flex items-center gap-2">
                                                ...
                                                <span class="text-white font-semibold text-sm">{{ $program->duration }}</span>
                                            </div>
                                        @endif
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-3xl">
                <div class="relative h-64 overflow-hidden">
                    <img src="{{asset('/img/program-img-1.png')}}" alt="Degree Programs" class="w-full h-full object-cover">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('programs.degree') }}" class="block w-full text-center bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold py-4 px-6 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-3xl">
                <div class="relative h-64 overflow-hidden">
                    <img src="{{asset('/img/program-people.png')}}" alt="Non-Degree Programs" class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                    <div class="absolute bottom-0 left-0 p-6">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('programs.non-degree') }}" class="block w-full text-center bg-gradient-to-r from-purple-600 to-purple-700 text-white font-bold py-4 px-6 rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        Choose Your Program
                        <svg class="inline-block w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                        </svg>
