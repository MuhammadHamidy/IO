<x-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <div class="flex flex-wrap justify-center gap-8 mt-10">
                    <div class="text-center">
                        <div class="text-4xl md:text-5xl font-bold text-[#1F4894] mb-2">{{ $pagePartners->flatten()->count() }}+</div>
                        <div class="text-gray-600 font-medium">Global Partners</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl md:text-5xl font-bold text-[#2D5F3F] mb-2">{{ count($continents) }}</div>
            ...
            <div class="relative mb-12">
                ...
                <div class="overflow-hidden">
                    <div class="partner-slider-wrapper flex gap-6 animate-slide hover:pause-animation" id="partner-slider">
                        <!-- First Set -->
                        @foreach($pagePartners->flatten() as $partner)
                            <a href="{{ route('partners.detail', ['id' => $partner->id]) }}" class="flex-shrink-0 w-64 group">
                                <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-gray-100 hover:border-[#C4D25A] h-full">
                                    ...
                                    <div class="px-4 py-3 bg-gray-50 border-t border-gray-100">
                                        <p class="text-xs text-center text-gray-600 font-medium truncate">{{ $partner->name }}</p>
                                    </div>
                                </div>
                            </a>
                        @endforeach
                        ...
                        @foreach($pagePartners->flatten() as $partner)
                            <a href="{{ route('partners.detail', ['id' => $partner->id]) }}" class="flex-shrink-0 w-64 group" aria-hidden="true">
                                <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-gray-100 hover:border-[#C4D25A] h-full">
                                    <div class="aspect-w-1 aspect-h-1 bg-gray-50 p-6 flex items-center justify-center min-h-[180px]">
                                        @if($partner->logo)
                                            <img src="{{ asset('storage/' . $partner->logo) }}" 
            ...
            <!-- Explore More Button -->
            <div class="text-center">
                <a href="{{ route('partners-by-region') }}" class="inline-flex items-center gap-3 bg-[#2D5F3F] text-white font-bold px-10 py-5 rounded-xl hover:bg-[#234a31] transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
    ...
    <div id="collaborate" class="relative bg-gradient-to-br from-[#1F4894] via-[#275DCB] to-[#2D5F3F] py-24 px-4 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto text-center relative z-10">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">{{ __('Partner With Universitas Pertamina') }}</h1>
            ...
            <div class="relative bg-gradient-to-br from-[#1F4894] via-[#275DCB] to-[#2D5F3F] rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="relative z-10 p-8 md:p-12 lg:p-16 text-white">
                    <div class="text-center mb-10">
                        ...
                        <h2 class="text-3xl md:text-5xl font-bold mb-4">{{ __('Start Your Partnership Journey') }}</h2>
                ...
                <div class="grid md:grid-cols-2 gap-0">
                    ...
                    <div class="p-12 flex items-center">
                        <div>
                            ...
                            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">{{ __('Download Partnership Information') }}</h2>
