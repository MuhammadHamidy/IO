...
<?php $component->withAttributes([]); ?>
    ...
    <div class="relative bg-gradient-to-br from-[#1F4894] via-[#275DCB] to-[#2D5F3F] py-20 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center">
                <a href="<?php echo e(route('global-network')); ?>" class="inline-flex items-center gap-2 text-white hover:text-[#C4D25A] transition-colors mb-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 -mt-16 relative z-10">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 mb-8">
            <div class="grid lg:grid-cols-3 gap-0">
                ...
                <div class="lg:col-span-1 bg-gradient-to-br from-gray-50 to-white p-8 md:p-12 flex flex-col items-center justify-center border-r border-gray-100">
                    <?php if($pagePartner->logo): ?>
                        <div class="w-48 h-48 rounded-2xl overflow-hidden shadow-lg mb-6 bg-white p-4">
                            <img src="<?php echo e(asset('storage/' . $pagePartner->logo)); ?>" alt="<?php echo e($pagePartner->name); ?>" class="w-full h-full object-contain">
                        </div>
                    <?php else: ?>
                    ...
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2 text-center"><?php echo e($pagePartner->name); ?></h2>
                    ...
                    <div class="flex items-center gap-2 text-gray-600 mb-4">
                        ...
                        <span class="font-medium"><?php echo e($pagePartner->regional); ?>, <?php echo e($countryName); ?></span>
                    </div>
                    
                    <?php if($pagePartner->category): ?>
                        <div class="inline-flex items-center gap-2 bg-blue-50 text-[#1F4894] px-4 py-2 rounded-lg mb-6">
                            <?php if($pagePartner->category === 'University'): ?> 
                                <span class="text-lg">🎓</span>
                            <?php elseif($pagePartner->category === 'Organization'): ?> 
                                <span class="text-lg">🏢</span>
                            <?php elseif($pagePartner->category === 'Embassy'): ?> 
                                <span class="text-lg">🏛️</span>
                            <?php elseif($pagePartner->category === 'Government Agency'): ?> 
                                <span class="text-lg">🏛️</span>
                            <?php else: ?> 
                                <span class="text-lg">💼</span>
                            <?php endif; ?>
                            <span class="font-semibold text-sm"><?php echo e($pagePartner->category); ?></span>
                        </div>
                    <?php endif; ?>
                    
                    <?php if($pagePartner->website): ?>
                        <a href="<?php echo e($pagePartner->website); ?>" target="_blank" class="inline-flex items-center gap-2 bg-[#C4D25A] text-[#1F4894] font-bold px-8 py-4 rounded-xl hover:bg-[#d4e068] transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 w-full justify-center">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="lg:col-span-2 p-8 md:p-12">
                    <?php if($pagePartner->description): ?>
                        <div class="mb-8">
                            ...
                            <div class="space-y-3 text-gray-700 leading-relaxed">
                                <?php $__currentLoopData = $pagePartner->description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($pagePartner->partnership_start_date || $pagePartner->partnership_end_date): ?>
                        <div class="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-6 mb-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                <?php if($pagePartner->partnership_start_date): ?>
                                    <div class="bg-white rounded-xl p-4 shadow-sm">
                                        <p class="text-sm text-gray-600 mb-1">Start Date</p>
                                        <p class="text-lg font-bold text-[#1F4894]"><?php echo e(\Carbon\Carbon::parse($pagePartner->partnership_start_date)->format('F d, Y')); ?></p>
                                    </div>
                                <?php endif; ?>
                                <?php if($pagePartner->partnership_end_date): ?>
                                    <div class="bg-white rounded-xl p-4 shadow-sm">
                                        <p class="text-sm text-gray-600 mb-1">End Date</p>
                                        <p class="text-lg font-bold text-[#2D5F3F]"><?php echo e(\Carbon\Carbon::parse($pagePartner->partnership_end_date)->format('F d, Y')); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <!-- Partnership Type -->
                    <?php if($pagePartner->partnership_type && count($pagePartner->partnership_type) > 0): ?>
                        <div class="mb-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = $pagePartner->partnership_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Cooperation Fields -->
                    <?php if($pagePartner->cooperation_fields && count($pagePartner->cooperation_fields) > 0): ?>
                        <div class="mb-6">
                            <h4 class="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = $pagePartner->cooperation_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="space-y-4">
            <!-- English Proficiency -->
            <?php if($pagePartner->english_profiency): ?>
                <div x-data="{ open: false }" class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all">
                    ...
                    <div x-show="open" x-transition class="p-6 bg-gray-50 border-t border-gray-100">
                        <ul class="space-y-3">
                            <?php $__currentLoopData = $pagePartner->english_profiency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proficiency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-start gap-3">
                                    ...
                                    <span class="text-gray-700"><?php echo e($proficiency); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
            ...
            <!-- Eligible Department -->
            <?php if($pagePartner->eligible_departement): ?>
                <div x-data="{ open: false }" class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between bg-gradient-to-r from-white to-gray-50 hover:from-gray-50 hover:to-white transition-all">
                        <div class="flex items-center gap-4">
                    ...
                    <div x-show="open" x-transition class="p-6 bg-gray-50 border-t border-gray-100">
                        <ul class="space-y-3">
                            <?php $__currentLoopData = $pagePartner->eligible_departement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-[#C4D25A] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-700"><?php echo e($department); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
            ...
            <!-- Study Period -->
            <?php if($pagePartner->study_periode): ?>
                <div x-data="{ open: false }" class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all">
                    <button @click="open = !open" class="w-full px-6 py-5 flex items-center justify-between bg-gradient-to-r from-white to-gray-50 hover:from-gray-50 hover:to-white transition-all">
                        <div class="flex items-center gap-4">
                    ...
                    <div x-show="open" x-transition class="p-6 bg-gray-50 border-t border-gray-100">
                        <ul class="space-y-3">
                            <?php $__currentLoopData = $pagePartner->study_periode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-[#C4D25A] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-700"><?php echo e($period); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
            ...
            <!-- Contact Information -->
            <?php if($pagePartner->contact_person || $pagePartner->contact_email || $pagePartner->contact_phone): ?>
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6 bg-gray-50 border-t border-gray-100">
                        <div class="grid md:grid-cols-3 gap-4">
                            <?php if($pagePartner->contact_person): ?>
                                <div class="bg-white rounded-xl p-4 shadow-sm">
                                    ...
                                    <p class="font-semibold text-gray-900"><?php echo e($pagePartner->contact_person); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if($pagePartner->contact_email): ?>
                                <div class="bg-white rounded-xl p-4 shadow-sm">
                                    <p class="text-sm text-gray-600 mb-1 flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    ...
                                    <a href="mailto:<?php echo e($pagePartner->contact_email); ?>" class="font-semibold text-[#1F4894] hover:text-[#275DCB] transition-colors"><?php echo e($pagePartner->contact_email); ?></a>
                                </div>
                            <?php endif; ?>
                            <?php if($pagePartner->contact_phone): ?>
                                <div class="bg-white rounded-xl p-4 shadow-sm">
                                    <p class="text-sm text-gray-600 mb-1 flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="tel:<?php echo e($pagePartner->contact_phone); ?>" class="font-semibold text-[#1F4894] hover:text-[#275DCB] transition-colors"><?php echo e($pagePartner->contact_phone); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <?php if($pagePartner->fact_sheet): ?>
                <div class="bg-gradient-to-br from-[#1F4894] via-[#275DCB] to-[#2D5F3F] rounded-2xl shadow-lg p-8 text-white">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(asset('storage/'.$pagePartner->fact_sheet)); ?>" target="_blank" class="inline-flex items-center gap-2 bg-[#C4D25A] text-[#1F4894] font-bold px-8 py-4 rounded-xl hover:bg-[#d4e068] transition-all duration-300 shadow-lg hover:scale-105">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/see-detail.js']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Kuliah\laragon\www\KP\IO-web\resources\views/detail-partners.blade.php ENDPATH**/ ?>