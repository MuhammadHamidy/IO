...
<div class="max-w-6xl mx-auto py-10 px-4 mt-4">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-2xl p-8 mb-8 shadow-2xl">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-blue-100 text-lg"><?php echo e($program->title ?? $program->name); ?></p>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
        ...
        <?php if($program->duration): ?>
            <div class="mb-4 flex items-center text-gray-700 bg-blue-50 px-4 py-3 rounded-lg">
                ...
                <span class="font-semibold">Duration: <?php echo e($program->duration); ?></span>
            </div>
        <?php endif; ?>
    ...
    <form action="<?php echo e(route('user.applications.store', $program->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div>
                    ...
                    <div class="relative">
                        <input type="text" value="<?php echo e(auth()->user()->name); ?>" class="border-2 border-gray-200 rounded-xl w-full p-3 bg-gray-50 text-gray-600 font-medium" disabled />
            ...
            <div>
                    ...
                    <div class="relative">
                        <input type="email" value="<?php echo e(auth()->user()->email); ?>" class="border-2 border-gray-200 rounded-xl w-full p-3 bg-gray-50 text-gray-600 font-medium" disabled />
                        <svg class="absolute right-3 top-3.5 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                        </svg>
                    </div>
            ...
            <div>
                    ...
                    <div class="relative">
                        <input type="text" value="<?php echo e(auth()->user()->phone ?? 'Not provided'); ?>" class="border-2 border-gray-200 rounded-xl w-full p-3 bg-gray-50 text-gray-600 font-medium" disabled />
                        <svg class="absolute right-3 top-3.5 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                        </svg>
                    </div>
            ...
            <div>
                    ...
                    <div class="relative">
                        <input type="text" value="<?php echo e(auth()->user()->nationality ?? 'Not provided'); ?>" class="border-2 border-gray-200 rounded-xl w-full p-3 bg-gray-50 text-gray-600 font-medium" disabled />
                        <svg class="absolute right-3 top-3.5 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                        </svg>
                    </div>
        ...
        <div>
            ...
            <div class="space-y-4">
                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white border-2 <?php echo e(auth()->user()->{$doc['field']} ? 'border-green-200' : 'border-orange-200'); ?> rounded-xl p-5 hover:shadow-md transition-shadow">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center flex-1">
                                ...
                                <?php endif; ?>
                                <div class="flex-1">
                                    <h3 class="font-bold text-gray-900"><?php echo e($doc['name']); ?></h3>
                                    <?php if(auth()->user()->{$doc['field']}): ?>
                        ...
                        <div class="mt-3">
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <?php echo e(auth()->user()->{$doc['field']} ? 'Upload New File (Optional - will replace profile document)' : 'Upload File (Required)'); ?>

                            </label>
                            <input 
                                type="file" 
                                name="<?php echo e($doc['input_name']); ?>" 
                                ...
                                <?php echo e(auth()->user()->{$doc['field']} ? '' : 'required'); ?>

                            />
                            <p class="text-xs text-gray-500 mt-1">PDF, DOC, DOCX, JPG, PNG (Max: 5MB)</p>
                            <?php $__errorArgs = [$doc['input_name']];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50 p-6 rounded-2xl">
            <a href="<?php echo e(route('user.applications.index')); ?>" class="w-full sm:w-auto px-8 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 flex items-center justify-center">
...
<?php endif; ?><?php /**PATH C:\Kuliah\laragon\www\KP\IO-web\resources\views/user/applications/create.blade.php ENDPATH**/ ?>