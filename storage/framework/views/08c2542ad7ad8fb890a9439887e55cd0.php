            ...
            <div class="p-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-gray-700 text-base leading-relaxed"><?php echo e(session('success')); ?></p>
                    </div>
            ...
            <div class="p-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-gray-700 text-base leading-relaxed"><?php echo e(session('error')); ?></p>
                    </div>
                    <button @click="show = false" class="ml-4 text-gray-400 hover:text-gray-700 transition-colors p-2 hover:bg-gray-100 rounded-lg">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
            ...
            <div class="p-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-gray-700 text-base leading-relaxed"><?php echo e(session('warning')); ?></p>
                    </div>
                    <button @click="show = false" class="ml-4 text-gray-400 hover:text-gray-700 transition-colors p-2 hover:bg-gray-100 rounded-lg">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
            ...
            <div class="p-8">
                <div class="flex items-start">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-gray-700 text-base leading-relaxed"><?php echo e(session('info')); ?></p>
                    </div>
                    <button @click="show = false" class="ml-4 text-gray-400 hover:text-gray-700 transition-colors p-2 hover:bg-gray-100 rounded-lg">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
...
<?php /**PATH C:\Kuliah\laragon\www\KP\IO-web\resources\views/components/toast-notification.blade.php ENDPATH**/ ?>