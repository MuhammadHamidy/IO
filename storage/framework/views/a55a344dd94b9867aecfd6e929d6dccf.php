        ...
        <div class="flex flex-col px-20 py-10 bg-[#1F4894] bg-opacity-85 gap-4 sm:gap-12">
            ...
            <form class="w-full h-fit flex flex-col gap-2" method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <div class="my-6 text-[14px] text-white">Have account already? <a href="<?php echo e(route('login-inbound')); ?>" class="text-white underline"><?php echo e(__('Login here')); ?></a></div>
                </div>
                <script>
        ...
        document.querySelector('form').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    window.location.href = '<?php echo e(route('login-inbound')); ?>';
                } else {
                    if (data.errors) {
...
<?php endif; ?>
<?php /**PATH C:\Kuliah\laragon\www\KP\IO-web\resources\views/regist-inbound.blade.php ENDPATH**/ ?>