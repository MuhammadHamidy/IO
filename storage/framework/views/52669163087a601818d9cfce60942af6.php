...
<head>
    ...
    <title>Admin Dashboard - <?php echo e(config('app.name', 'Laravel')); ?></title>
...
<body class="font-poppins bg-gray-100">
    ...
    <div class="admin-sidebar fixed top-0 left-0 h-full w-64 bg-gray-800 text-white z-50 overflow-y-auto flex flex-col" id="admin-sidebar">
        ...
        <nav class="mt-4 flex-1 overflow-y-auto">
            <div class="px-4 py-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-700 text-white' : ''); ?>">
            ...
            <div class="space-y-1 px-2">
                <a href="<?php echo e(route('admin.news.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 <?php echo e(request()->routeIs('admin.news.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.events.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 <?php echo e(request()->routeIs('admin.events.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.partners.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 <?php echo e(request()->routeIs('admin.partners.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.testimonials.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 <?php echo e(request()->routeIs('admin.testimonials.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.programs.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 <?php echo e(request()->routeIs('admin.programs.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.applications.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200 <?php echo e(request()->routeIs('admin.applications.*') ? 'bg-gray-700 text-white' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-1 px-2 mb-4">
                <a href="<?php echo e(route('admin.toggle-preview')); ?>?redirect=<?php echo e(urlencode(route('home'))); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-colors duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <nav class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="ml-3 text-xl font-semibold text-gray-900"><?php echo $__env->yieldContent('page-title', 'Admin Dashboard'); ?></h1>
                </div>
                
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-600">Welcome, <?php echo e(Auth::user()->name); ?></span>
...
<?php /**PATH C:\Kuliah\laragon\www\KP\IO-web\resources\views/components/admin-layout.blade.php ENDPATH**/ ?>